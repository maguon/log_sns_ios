            ...
            <ScrollView style={globalStyles.container}>
                <List >
                    <Item arrow="horizontal"
                          onPress={() => { navigation.navigate('FollowMe') }}
                          extra={<View style={styles.extra}><Text style={styles.extraText}>1</Text></View>}
                          thumb={<Image source={require('../../images/focus.png')} style={{ width: 25, height: 25,marginRight:10 }}/>}>
                          <Text style={globalStyles.largeText}>关注我</Text></Item>
                    <Item arrow="horizontal"
                          onPress={() => { navigation.navigate('EvaluationMe') }}
                          extra={<View style={styles.extra}><Text style={styles.extraText}>2</Text></View>}
                          thumb={<Image source={require('../../images/tall.png')} style={{ width: 25, height: 25,marginRight:10 }}/>} >
                        <Text style={globalStyles.largeText}>评论我</Text></Item>
                    <Item arrow="horizontal"
                          onPress={() => { navigation.navigate('PraiseMe') }}
                          extra={<View style={styles.extra}><Text style={styles.extraText}>3</Text></View>}
                         thumb={<Image source={require('../../images/praise.png')} style={{ width: 25, height: 25,marginRight:10 }}/>} >
                ...
                <List>
                    <Item arrow="horizontal"
                          ...
                          thumb={<Image source={require('../../images/vote.png')} style={{ width: 25, height: 25,marginRight:10 }}/>} >
