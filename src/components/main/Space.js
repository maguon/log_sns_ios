...
class Space extends Component {
    ...
    render() {
        const {spaceReducer: {spaceData, spaceUser, spaceHidden, isComplete, spaceLoading, isResultStatus}, getSpaceData, navigation, setCollection, navigation: {state: {params: {userId}}}} = this.props
                    ...
                    <View style={{width: width, backgroundColor: styleColor,}}>
                        ...
                        <View style={{flexDirection: "row", alignItems: "center", marginTop: 10}}>
                            <View style={{marginLeft: 10, marginRight: 10, marginBottom: 25}}>
                                {spaceUser.avatar ? <TouchableOpacity onPress={() => {
                                        navigation.navigate("HeadImage", {
                                            uri: spaceUser.avatar
                                        })}}>
